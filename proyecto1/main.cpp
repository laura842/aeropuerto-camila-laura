...
int main(){
    ...
    while (opcion != 6) {
        ...
        cout << "4. Ver todos los vuelos" << endl;
        ...
        switch (opcion) {
            ...
            case 4: {
                cout << "A continuacion se muestra la lista de los vuelos:" << endl;
                vector<Vuelo *> vuelosd = Aeropuerto::getInstancia().getVuelosDisp();
                for (int i = 0; i < vuelosd.size(); i++) {
                    cout << i + 1 << "." << endl;
                    cout << "ID: " << vuelosd[i]->getId() << endl;
                    cout << "Fecha: " << vuelosd[i]->getFecha() << endl;
                    cout << "Origen: " << vuelosd[i]->getOrigen() << endl;
                    cout << "Destino: " << vuelosd[i]->getDestino() << endl;
                    // cout << "Puerta asignada: " << vuelosd[i]->getPuertaAsign() << endl;
                    cout << "Sillas disponibles: " << vuelosd[i]->getSillasDisponibles() << endl;
                    /*vector<Tripulacion *> tripV = vuelosd[i]->getTripAsignada();
                    cout << "Tripulacion asignada para el vuelo: " << endl;
                    for (int j = 0; i < tripV.size(); i++) {
                        cout << tripV[j] << endl;
                    }*/
                }
                break;
