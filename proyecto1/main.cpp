                        ...
                        switch (opcAdmin) {
                            ...
                            case 2:{
                                ...
                                if(tipoAero == 1){
                                    ...
                                    Avion* nuevoAvion = new Avion(marcaR, modeloR, capacidadR, velocidadMaxR, autonomiaR, fechaFabR, estadoR, totalAsignR, altitudMaxR, motoresR, categoriaR);
                                }
                                else if(tipoAero == 2){
                                    int rotoresR = 0;
                                    int capElevR = 0;
                                    ...
                                    Helicoptero* nuevoHelicoptero = new Helicoptero(marcaR, modeloR, capacidadR, velocidadMaxR, autonomiaR, fechaFabR, estadoR, totalAsignR, rotoresR, capElevR, usoEspR);
