...
class Helicoptero : public Aeronave{
    ...
    public:
    Helicoptero();
    Helicoptero(string marca,string id, string modelo,int capacidad,int velocidadMax,string autonomia,int fechaFab,string estado,bool totalAsign,int rotores, int capElevacion, string usoEspecifico);
